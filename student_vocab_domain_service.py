...
def build_questions_from_vocab_rows(vocab_map: dict[int, tuple[str, str]], rows: list[dict[str, Any]], test_mode: str) -> list[dict[str, Any]]:
    ...
    for row in rows:
        ...
        one_mode = random.choice([EN_TO_ZH_MODE, ZH_TO_EN_MODE]) if test_mode == MIXED_TEST_MODE else test_mode
        question = {
